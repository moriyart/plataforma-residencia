        ...
        <body className={`${inter.className} bg-slate-50 text-slate-900`}>
          ...
          <SignedOut>
            <div className="flex flex-col items-center justify-center min-h-screen bg-white p-6">
              <h1 className="text-3xl font-black text-violet-600 mb-4 tracking-tighter">ESTUDEI.</h1>
              <p className="text-slate-500 mb-8 font-medium">Faça login para acessar seu cronograma.</p>
