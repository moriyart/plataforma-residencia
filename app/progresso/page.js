  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      <header className="mb-10 text-center md:text-left">
        ...
        <p className="text-slate-500 font-medium italic">Dados sincronizados na nuvem ☁️</p>
      </header>
      ...
      <div className="mt-12 bg-slate-800 p-10 rounded-[3rem] text-center text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-slate-400">Cada tarefa concluída te deixa mais perto da aprovação.</p>
        </div>
